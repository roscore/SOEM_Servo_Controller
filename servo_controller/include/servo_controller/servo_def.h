...
#define STATUSWORD_NOT_USED_BIT     			    8
#define STATUSWORD_REMOTE_BIT 					    9
#define STATUSWORD_TARGET_REACHED_BIT 			    10
#define STATUSWORD_INTERNAL_LIMIT_ACTIVE_BIT	    11
#define STATUSWORD_OPERATION_MODE_SPECIFIC_BIT_0	12
#define STATUSWORD_OPERATION_MODE_SPECIFIC_BIT_1	13
#define STATUSWORD_ABS_POSITIOON_VALID_BIT     	    14
#define STATUSWORD_DRIVE_SPECIFIC_BIT       	    15
...
#define OP_MODE_VELOCITY					(0X01)
#define OP_MODE_PROFILE_VELOCITY			(0X02)
#define OP_MODE_TORQUE_PROFILE				(0X03)
#define OP_MODE_HOMING						(0X05)
#define OP_MODE_INTERPOLATED_POSITION		(0X06)
#define OP_MODE_CYCLIC_SYNC_POSITION		(0X07)
#define OP_MODE_CYCLIC_SYNC_VELOCITY		(0X08)
