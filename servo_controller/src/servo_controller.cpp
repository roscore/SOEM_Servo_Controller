    ...
    if(run_flag == true)
    {
      for(int iter = 0; iter < NUMOFSERVO_DRIVE; iter++)
      {
        ...
        if(play_count % 2 == 1)
        {
          ...
          // if((iter+1 == 1) || (iter+1 == 6))
          // {
          //   target_position = 73860;
          // }
          // else if((iter+1 == 2) || (iter+1 == 5))
          // {
          //   target_position = 57312;
          // }
          // else if((iter+1 == 3) || (iter+1 == 4))
          // {
          //   target_position = 77076;
          // }
          os=sizeof(target_position);
          if(iter+1 == 1)        target_position = 71845;
          else if(iter+1 == 2)   target_position = 81926;
          else if(iter+1 == 3)   target_position = 80838;
          else if(iter+1 == 4)   target_position = 40573;
          else if(iter+1 == 5)   target_position = 22355;
          else if(iter+1 == 6)   target_position = 55745;
          else if(iter+1 == 7)   target_position = 71845;
          else if(iter+1 == 8)   target_position = 81926;
          else if(iter+1 == 9)   target_position = 80838;
          else if(iter+1 == 10)  target_position = 40573;
          else if(iter+1 == 11)  target_position = 22355;
          else if(iter+1 == 12)  target_position = 55745;
        ...
        else if((play_count % 2 == 0) && (play_count != 0))
        {
          os=sizeof(mode_of_driver); mode_of_driver = 0x00;
          ec_SDOread(iter+1, 0x6041,0x00, FALSE, &os, &mode_of_driver, EC_TIMEOUTRXM); //read status of driver
          printf("Mode of driver: %d\n", mode_of_driver);
          ...
          os=sizeof(target_position);
          if(iter+1 == 1)        target_position = 50686;
          else if(iter+1 == 2)   target_position = 20828;
          else if(iter+1 == 3)   target_position = 41855;
          else if(iter+1 == 4)   target_position = 79578;
          else if(iter+1 == 5)   target_position = 83248;
          else if(iter+1 == 6)   target_position = 76889;
          else if(iter+1 == 7)   target_position = 50686;
          else if(iter+1 == 8)   target_position = 20828;
          else if(iter+1 == 9)   target_position = 41855;
          else if(iter+1 == 10)   target_position = 79578;
          else if(iter+1 == 11)   target_position = 83248;
          else if(iter+1 == 12)   target_position = 76889;
          ec_SDOwrite(iter+1, 0x607A,0x00, FALSE, os, &target_position, EC_TIMEOUTRXM); //read status of driver
          printf("Target Position(write) of driver: %d\n", target_position);
        ...
        else if(play_count == 0)
        {
          ...
          os=sizeof(target_position);
          if((iter+1 == 1) || (iter+1 == 6) || (iter+1 == 7) || (iter+1 == 12) )
          {
            target_position = 73860;
          }
          else if((iter+1 == 2) || (iter+1 == 5) || (iter+1 == 8) || (iter+1 == 11) )
          {
            target_position = 57312;
          }
          else if((iter+1 == 3) || (iter+1 == 4) || (iter+1 == 9) || (iter+1 == 10) )
          {
            target_position = 77076;
          }
          ec_SDOwrite(iter+1, 0x607A,0x00, FALSE, os, &target_position, EC_TIMEOUTRXM); //read status of driver
      ...
      if(play_count == 10)  run_flag = false;
    }
